...
If you are using the [cardioception toolbox](https://github.com/LegrandNico/cardioception) for your research, we ask you to cite the following paper in the final publication:
